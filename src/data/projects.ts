...
export const projects: Project[] = [
  {
    ...
    technologies: ['Next.js', 'NestJS', 'TypeScript', 'PostgreSQL', 'TypeORM', 'Tailwind CSS', 'JWT'],
    categories: ['Full Stack', 'Sistemas'],
    repositoryUrl: 'https://github.com/marcosvitordev/pokemon-management-system',
    status: 'Concluído',
    featured: true,
    highlights: ['Autenticação JWT', 'CRUD completo', 'Paginação', 'Documentação Swagger', 'Filtros por espécie'],
  },
  {
    ...
    status: 'Em evolução',
    featured: true,
    highlights: ['Motor de aprazamento', 'Calendário posológico', 'Auditoria', 'Controle de sessão'],
  },
  {
    id: 'gestao-medica',
    ...
    technologies: ['Next.js', 'Node.js', 'Express.js', 'TypeScript', 'Prisma ORM', 'DigitalOcean Spaces'],
    categories: ['Full Stack', 'Sistemas'],
    status: 'Privado',
    featured: true,
