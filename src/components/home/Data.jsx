    ...
    return (
        <div className="home__data">
            <h1 className="home__title">
                Marcos Vitor<span className='home__icon-lg'>🙋🏼‍♂️</span>
                {/* <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">
                <Typewriter
                    words={['Full Stack Developer', 'Engenheiro de Software', 'Analista de Sistema']}
                    loop={0}
                    cursor
                    cursorStyle="|"
                    typeSpeed={70}
            ...
            <p className="home__description">
                Sou um entusiasta apaixonado por tecnologia e desenvolvedor de sistemas em Sena Madureira, Acre. Sou dedicado à criação de soluções inovadoras e tudo que envolve software e design.
            </p>
