...
const projetos = [
    ...
    techs: "Node.js, Next.js, Express.js (API REST), DigitalOcean Spaces (Bucket Storage), typeScript, Prisma ORM",
  ...
  },
  {
    ...
    github: "https://github.com/Solar-Software-Laboratory/Qatar-2022-Jogo-da-Memoria",
    demo: "#",
    imagem: imgProjeto3
  },
  {
        ...
        <div className="work__data">
          ...
          <div className="work__buttons">
            <a href={projeto.demo} target="_blank" rel="noreferrer">
              <span><i className="uil uil-link work__link__link"></i></span> Ver Projeto
            </a>

            <a href={projeto.github} target="_blank" rel="noreferrer">
              <span><i className="uil uil-github work__link__link"></i></span> GitHub
            </a>
          </div>
        </div>
